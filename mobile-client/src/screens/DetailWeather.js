                ...
                >
                  ...
                  <Stack p="4" space={3} style={{ backgroundColor: "#e2e8f0" }}>
                    ...
                    <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-around" }}>
                      <Text fontWeight="400" style={{ marginStart: 5 }}>
                        {" "}
                        Jarak Pandang: {data.fetchCurrentWeather.current.visibility / 1000} Km{" "}
                      </Text>
                      <MaterialCommunityIcons name="air-humidifier">
                        <Text fontWeight="400" style={{ marginStart: 10 }}>
                          {data.fetchCurrentWeather.current.humidity} %
                        </Text>{" "}
                      </MaterialCommunityIcons>
                    </View>
                    <TouchableOpacity>
                      <Button style={{ backgroundColor: "#22d3ee" }} mt="0" onPress={() => navigation.navigate("FormCuaca", { item: data.fetchCurrentWeather })}>
                        Report Cuaca
                      </Button>
                    </TouchableOpacity>
                  </Stack>
              ...
              {loading2 ? (
                ...
                <ScrollView horizontal={true} style={{ width: "100%" }}>
                  <Center flex={1} px="2.5" bg="#ffedd5">
                    <FlatList data={data2.getWeatherReports} renderItem={renderItem} keyExtractor={(item) => item.id} />
                  </Center>
                </ScrollView>
              )}
            </View>
