                    ...
                    >
                      <Callout>
                        <Svg width={240} height={120}>
                          <ImageSvg width={"100%"} height={"100%"} preserveAspectRatio="xMidYMid slice" href={{ uri: marker.photoUrl }} />
                        </Svg>
          ...
          <Box alignItems="center" mt="2">
            ...
            >
              <Stack p="4" space={3}>
                  ...
                  <Box w="100%">
                    ...
                    <View m="2">
                      ...
                      <Ionicons color="#fde047" name="map">
                        <Text fontSize="xs" color="#fff">
                          {" "}
                          (skala MMI) dirasakan pada Wilayah : {data.getRecentEarthquake.dirasakan}
                        </Text>
                      </Ionicons>
                ...
                <Button colorScheme="orange" mt="2" onPress={() => navigation.navigate("FormGempa", { item: data.getRecentEarthquake })}>
                  Form Pengaduan Gempa
                </Button>
              </Stack>
            </Box>
          </Box>
